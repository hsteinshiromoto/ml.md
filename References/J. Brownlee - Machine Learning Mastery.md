...
Again, using probability notation, this would be written as $P(\text{data}|\text{hypothesis})$. It allows us to reason about whether or not the data fits the hypothesis. Not the other way around.
